...
sub_tema theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of sub_tema theme and run the following commands:
`nvm use`
...
`drush en sub_tema -y`
`drush config-set system.theme default sub_tema -y`
